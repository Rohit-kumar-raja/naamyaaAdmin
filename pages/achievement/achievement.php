...
if (isset($_SESSION['username']) && ($_SESSION['username'] != '')) {
  $select = "SELECT * FROM `archievment` WHERE 1";
              ...
              <div class="card">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">All Achievement of The Product</h3>
                  </div>
                  <!-- /.card-header -->
                  <?php
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td> <a target="_blank" href="https://naamyaafoundation.org/achievement.php">more</a> </td>

...
if (isset($_SESSION['username']) && ($_SESSION['username'] != '')) {
  $team_member = "SELECT * FROM `team_member` WHERE 1";
  $result_team_member = mysqli_query($connection, $team_member);
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <a href="" class="btn btn-primary text-center" data-toggle="modal" data-target="#insert">Add team_member
          </a>
        </section>
